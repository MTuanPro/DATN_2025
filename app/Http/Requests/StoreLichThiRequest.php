...
class StoreLichThiRequest extends FormRequest
{
    ...
    public function attributes(): array
    {
        return [
            ...
            'link_thi_online' => 'link thi online',
            'de_thi_file' => 'đề thi',
            'dap_an_file' => 'đáp án',
            'ghi_chu' => 'ghi chú',
        ];
    ...
    public function messages(): array
    {
        return [
            ...
            'hinh_thuc_thi.required' => 'Vui lòng chọn hình thức thi.',
            'hinh_thuc_thi.in' => 'Hình thức thi không hợp lệ.',
            'link_thi_online.url' => 'Link thi online không đúng định dạng.',

...
@section('title', 'Import Lớp hành chính từ Excel')
    ...
    <div class="page-heading">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dao-tao.lop-hanh-chinh.index') }}">Lớp hành chính</a></li>
        ...
        <section class="section">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mt-3">
                        <a href="{{ route('dao-tao.lop-hanh-chinh.download-template') }}" class="btn btn-success btn-lg">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dao-tao.lop-hanh-chinh.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf

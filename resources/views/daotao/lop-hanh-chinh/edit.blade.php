...
@section('title', 'Sửa Lớp hành chính')
    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dao-tao.lop-hanh-chinh.update', $lopHanhChinh->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('ma_lop') is-invalid @enderror"
                                        id="ma_lop" name="ma_lop" value="{{ old('ma_lop', $lopHanhChinh->ma_lop) }}"
                                        required>
                                    @error('ma_lop')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('ten_lop') is-invalid @enderror"
                                        id="ten_lop" name="ten_lop" value="{{ old('ten_lop', $lopHanhChinh->ten_lop) }}"
                                        required>
                                    @error('ten_lop')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <select class="form-select @error('khoa_hoc_id') is-invalid @enderror" id="khoa_hoc_id"
                                        ...
                                        @foreach ($khoaHocs as $khoaHoc)
                                            <option value="{{ $khoaHoc->id }}"
                                                {{ old('khoa_hoc_id', $lopHanhChinh->khoa_hoc_id) == $khoaHoc->id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-select @error('nganh_id') is-invalid @enderror" id="nganh_id"
                                        ...
                                        @foreach ($nganhs as $nganh)
                                            <option value="{{ $nganh->id }}"
                                                {{ old('nganh_id', $lopHanhChinh->nganh_id) == $nganh->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('giang_vien_chu_nhiem_id') is-invalid @enderror"
                                        ...
                                        @foreach ($giangViens as $gv)
                                            <option value="{{ $gv->id }}"
                                                {{ old('giang_vien_chu_nhiem_id', $lopHanhChinh->giang_vien_chu_nhiem_id) == $gv->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ $lopHanhChinh->si_so }} sinh viên"
                                        readonly>

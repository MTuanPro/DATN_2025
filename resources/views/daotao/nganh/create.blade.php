...
<div class="container">
    ...
    {{-- Form thêm ngành --}}
    <form action="{{ route('dao-tao.nganh.store') }}" method="POST" class="card p-4 shadow-sm rounded-3">
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="text" id="ma_nganh" name="ma_nganh" class="form-control"
                   value="{{ old('ma_nganh') }}" placeholder="Nhập mã ngành, ví dụ: 7480201">
            @error('ma_nganh')
        ...
        <div class="mb-3">
            ...
            <input type="text" id="ten_nganh" name="ten_nganh" class="form-control"
                   value="{{ old('ten_nganh') }}" placeholder="Nhập tên ngành, ví dụ: Công nghệ Thông tin">
            @error('ten_nganh')
                <div class="text-danger mt-1">{{ $message }}</div>
            @enderror
        </div>

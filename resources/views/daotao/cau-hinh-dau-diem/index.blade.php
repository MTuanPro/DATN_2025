    ...
    <section class="section">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4 text-end">
                        <h4>Tổng tỷ lệ: <span class="badge {{ $tongTyLe == 100 ? 'bg-success' : 'bg-warning' }}">{{ $tongTyLe }}%</span></h4>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if($tyLeConLai > 0)
                <form action="{{ route('dao-tao.lop-hoc-phan.cau-hinh-diem.store', $lopHocPhan->id) }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                            <label class="form-label">Tên đầu điểm <span class="text-danger">*</span></label>
                            <input type="text" name="ten_dau_diem" class="form-control @error('ten_dau_diem') is-invalid @enderror" 
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" name="ty_le" class="form-control @error('ty_le') is-invalid @enderror" 
                                   step="0.01" min="0.01" max="{{ $tyLeConLai }}" placeholder="10" required>
                            @error('ty_le')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" name="so_cot" class="form-control @error('so_cot') is-invalid @enderror" 
                ...
                @else
                    <div class="alert alert-info">
                        ...
                        <a href="{{ route('dao-tao.lop-hoc-phan.index') }}" class="btn btn-sm btn-secondary">Quay lại</a>
                    </div>
                @endif
            </div>
        </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tfoot>
                            <tr class="table-primary">
                                ...
                                <th><span class="badge bg-{{ $tongTyLe == 100 ? 'success' : 'warning' }}">{{ $tongTyLe }}%</span></th>
                                <th colspan="3">
                                    @if($tongTyLe == 100)
                                        <span class="text-success"><i class="bi bi-check-circle"></i> Đã đủ 100%</span>
                                    @else
                                        <span class="text-warning"><i class="bi bi-exclamation-triangle"></i> Còn thiếu {{ $tyLeConLai }}%</span>
                                    @endif
                                </th>
                            </tr>
                        </tfoot>

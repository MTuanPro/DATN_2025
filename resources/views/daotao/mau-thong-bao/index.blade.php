            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('dao-tao.mau-thong-bao.create') }}" class="btn btn-primary">
                                    ...
                                    <tr>
                                        <td>
                                            <span class="badge bg-info">
                                                {{ \App\Models\MauThongBaoTuDong::getLoaiThongBaoOptions()[$mau->loai_thong_bao] ?? $mau->loai_thong_bao }}
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <form action="{{ route('dao-tao.mau-thong-bao.toggle', $mau->id) }}"
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('dao-tao.mau-thong-bao.show', $mau->id) }}"
                                                    class="btn btn-sm btn-info" title="Xem">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                <a href="{{ route('dao-tao.mau-thong-bao.edit', $mau->id) }}"
                                                    class="btn btn-sm btn-warning" title="Sửa">
                                                    <i class="bi bi-pencil"></i>
                                                </a>
                                                <form action="{{ route('dao-tao.mau-thong-bao.destroy', $mau->id) }}"
                                                    method="POST" class="d-inline"

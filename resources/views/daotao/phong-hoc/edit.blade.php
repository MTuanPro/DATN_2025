                ...
                <div class="card-body">
                    <form action="{{ route('dao-tao.phong-hoc.update', $phongHoc->id) }}" method="POST">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="ma_phong" name="ma_phong"
                                    ...
                                    value="{{ old('ma_phong', $phongHoc->ma_phong) }}" required>
                                @error('ma_phong')
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="ten_phong" name="ten_phong"
                                    ...
                                    value="{{ old('ten_phong', $phongHoc->ten_phong) }}" required>
                                @error('ten_phong')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="number" id="suc_chua" name="suc_chua"
                                    ...
                                    value="{{ old('suc_chua', $phongHoc->suc_chua) }}" min="1" max="500">
                                @error('suc_chua')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="vi_tri" name="vi_tri"
                                    class="form-control @error('vi_tri') is-invalid @enderror"
                            ...
                            <div class="col-md-8">
                                <select name="loai_phong" id="loai_phong"
                                    ...
                                    <option value="Lý thuyết"
                                        {{ old('loai_phong', $phongHoc->loai_phong) == 'Lý thuyết' ? 'selected' : '' }}>Lý
                                        thuyết</option>
                            ...
                            <div class="col-md-8">
                                <select name="trang_thai" id="trang_thai"
                                    ...
                                    <option value="Bảo trì"
                                        {{ old('trang_thai', $phongHoc->trang_thai) == 'Bảo trì' ? 'selected' : '' }}>Bảo
                                        trì</option>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <textarea id="mo_ta" name="mo_ta" rows="3" class="form-control @error('mo_ta') is-invalid @enderror">{{ old('mo_ta', $phongHoc->mo_ta) }}</textarea>
                                @error('mo_ta')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>

                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('hoc_ky_id') is-invalid @enderror" 
                                ...
                                @foreach($hocKys as $hocKy)
                                    <option value="{{ $hocKy->id }}" {{ old('hoc_ky_id') == $hocKy->id ? 'selected' : '' }}>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" class="form-control @error('suc_chua') is-invalid @enderror" 
                                   id="suc_chua" name="suc_chua" value="{{ old('suc_chua', 50) }}" 
                                   min="10" max="100">
                            @error('suc_chua')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" class="form-control @error('so_luong_toi_thieu') is-invalid @enderror" 
                                   id="so_luong_toi_thieu" name="so_luong_toi_thieu" value="{{ old('so_luong_toi_thieu', 10) }}" 
                                   min="5" max="30">

                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('ma_lop_hp') is-invalid @enderror"
                                    id="ma_lop_hp" name="ma_lop_hp" value="{{ old('ma_lop_hp') }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('ten_lop_hp') is-invalid @enderror"
                                    id="ten_lop_hp" name="ten_lop_hp" value="{{ old('ten_lop_hp') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control @error('nhom_lop') is-invalid @enderror"
                                    id="nhom_lop" name="nhom_lop" value="{{ old('nhom_lop', 1) }}" min="1">
                                @error('nhom_lop')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control @error('suc_chua') is-invalid @enderror"
                                    id="suc_chua" name="suc_chua" value="{{ old('suc_chua', 50) }}" min="10"
                                    max="100">
                                @error('suc_chua')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control @error('so_luong_toi_thieu') is-invalid @enderror"
                                    ...
                                    value="{{ old('so_luong_toi_thieu', 10) }}" min="5" max="30">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-select @error('hinh_thuc') is-invalid @enderror" id="hinh_thuc"
                                    name="hinh_thuc">
                                    <option value="offline" {{ old('hinh_thuc') == 'offline' ? 'selected' : '' }}>Offline
                                    </option>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <select class="form-select @error('trang_thai_lop') is-invalid @enderror"
                                    ...
                                    <option value="ket_thuc" {{ old('trang_thai_lop') == 'ket_thuc' ? 'selected' : '' }}>
                                        Kết thúc</option>
                                    <option value="huy" {{ old('trang_thai_lop') == 'huy' ? 'selected' : '' }}>Hủy
                                    </option>
                                </select>

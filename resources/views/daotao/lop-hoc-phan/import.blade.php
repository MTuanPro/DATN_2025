...
@section('title', 'Import Lớp học phần từ Excel')
    ...
    <div class="page-heading">
        ...
        <section class="section">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <ol>
                        ...
                        <li><strong>Lưu ý:</strong> Nếu Mã lớp học phần đã tồn tại, hệ thống sẽ tự động cập nhật thông tin thay vì tạo mới</li>
                    ...
                    <div class="text-center mt-3">
                        <a href="{{ route('dao-tao.lop-hoc-phan.download-template') }}" class="btn btn-success btn-lg">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dao-tao.lop-hoc-phan.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf

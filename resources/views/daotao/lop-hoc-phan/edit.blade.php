                    ...
                    <form action="{{ route('dao-tao.lop-hoc-phan.update', $lopHocPhan->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('ten_lop_hp') is-invalid @enderror"
                                    ...
                                    value="{{ old('ten_lop_hp', $lopHocPhan->ten_lop_hp) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="mon_hoc_id" class="form-label">Môn học <span
                                        class="text-danger">*</span></label>
                                <select class="form-select @error('mon_hoc_id') is-invalid @enderror" id="mon_hoc_id"
                                    name="mon_hoc_id">
                                    <option value="">-- Chọn môn học --</option>
                                    @foreach ($monHocs as $monHoc)
                                        <option value="{{ $monHoc->id }}"
                                            {{ old('mon_hoc_id', $lopHocPhan->mon_hoc_id) == $monHoc->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('hoc_ky_id') is-invalid @enderror" id="hoc_ky_id"
                                    name="hoc_ky_id">
                                    <option value="">-- Chọn học kỳ --</option>
                                    @foreach ($hocKys as $hocKy)
                                        <option value="{{ $hocKy->id }}"
                                            {{ old('hoc_ky_id', $lopHocPhan->hoc_ky_id) == $hocKy->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control @error('nhom_lop') is-invalid @enderror"
                                    id="nhom_lop" name="nhom_lop" value="{{ old('nhom_lop', $lopHocPhan->nhom_lop) }}"
                                    min="1">
                                @error('nhom_lop')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control @error('so_luong_toi_thieu') is-invalid @enderror"
                                    ...
                                    value="{{ old('so_luong_toi_thieu', $lopHocPhan->so_luong_toi_thieu) }}" min="5"
                                    max="30">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-select @error('hinh_thuc') is-invalid @enderror" id="hinh_thuc"
                                    ...
                                    <option value="offline"
                                        {{ old('hinh_thuc', $lopHocPhan->hinh_thuc) == 'offline' ? 'selected' : '' }}>
                                        Offline</option>
                                    <option value="online"
                                        {{ old('hinh_thuc', $lopHocPhan->hinh_thuc) == 'online' ? 'selected' : '' }}>Online
                                    </option>
                                    <option value="hybrid"
                                        {{ old('hinh_thuc', $lopHocPhan->hinh_thuc) == 'hybrid' ? 'selected' : '' }}>Hybrid
                                    </option>
                                </select>
                                @error('hinh_thuc')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('ngay_bat_dau') is-invalid @enderror"
                                    ...
                                    value="{{ old('ngay_bat_dau', $lopHocPhan->ngay_bat_dau ? $lopHocPhan->ngay_bat_dau->format('Y-m-d') : '') }}">
                                @error('ngay_bat_dau')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('ngay_ket_thuc') is-invalid @enderror"
                                    ...
                                    value="{{ old('ngay_ket_thuc', $lopHocPhan->ngay_ket_thuc ? $lopHocPhan->ngay_ket_thuc->format('Y-m-d') : '') }}">
                                @error('ngay_ket_thuc')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <select class="form-select @error('trang_thai_lop') is-invalid @enderror"
                                    ...
                                    <option value="mo_dang_ky"
                                        {{ old('trang_thai_lop', $lopHocPhan->trang_thai_lop) == 'mo_dang_ky' ? 'selected' : '' }}>
                                        Mở đăng ký</option>
                                    <option value="dang_hoc"
                                        {{ old('trang_thai_lop', $lopHocPhan->trang_thai_lop) == 'dang_hoc' ? 'selected' : '' }}>
                                        Đang học</option>
                                    <option value="ket_thuc"
                                        {{ old('trang_thai_lop', $lopHocPhan->trang_thai_lop) == 'ket_thuc' ? 'selected' : '' }}>
                                        Kết thúc</option>
                                    <option value="huy"
                                        {{ old('trang_thai_lop', $lopHocPhan->trang_thai_lop) == 'huy' ? 'selected' : '' }}>
                                        Hủy</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('ghi_chu') is-invalid @enderror" id="ghi_chu" name="ghi_chu" rows="3">{{ old('ghi_chu', $lopHocPhan->ghi_chu) }}</textarea>
                                @error('ghi_chu')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>

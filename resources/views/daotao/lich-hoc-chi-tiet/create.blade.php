    ...
    <div class="page-heading">
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Thêm buổi học (Bù học/Bổ sung)</h3>
                    ...
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ route('dao-tao.lop-hoc-phan.lich-chi-tiet', $lopHocPhan) }}">Lịch chi tiết</a>
                            </li>
                            <li class="breadcrumb-item active">Thêm buổi học</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dao-tao.lop-hoc-phan.lich-chi-tiet.store', $lopHocPhan) }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('ngay_hoc') is-invalid @enderror"
                                        id="ngay_hoc" name="ngay_hoc" value="{{ old('ngay_hoc') }}" required>
                                    @error('ngay_hoc')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('tiet_bat_dau') is-invalid @enderror"
                                        id="tiet_bat_dau" name="tiet_bat_dau" value="{{ old('tiet_bat_dau') }}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('tiet_ket_thuc') is-invalid @enderror"
                                        id="tiet_ket_thuc" name="tiet_ket_thuc" value="{{ old('tiet_ket_thuc') }}"
                                        min="1" max="10" required>
                                    @error('tiet_ket_thuc')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="noi_dung_giang_day" name="noi_dung_giang_day" rows="3">{{ old('noi_dung_giang_day') }}</textarea>
                        </div>

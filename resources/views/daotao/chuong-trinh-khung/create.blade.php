...
@section('title', 'Thêm môn học vào CTĐT')
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">{{ $chuyenNganh->nganh->khoa->ten_khoa }} -
                        {{ $chuyenNganh->nganh->ten_nganh }} - {{ $chuyenNganh->ten_chuyen_nganh }}</p>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dao-tao.chuong-trinh-khung.store') }}" method="POST">
                        @csrf
                        <input type="hidden" name="chuyen_nganh_id" value="{{ $chuyenNganh->id }}">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select @error('loai_mon_hoc') is-invalid @enderror"
                                        ...
                                        <option value="dai_cuong"
                                            {{ old('loai_mon_hoc') == 'dai_cuong' ? 'selected' : '' }}>Đại cương</option>
                                        <option value="co_so_nganh"
                                            {{ old('loai_mon_hoc') == 'co_so_nganh' ? 'selected' : '' }}>Cơ sở ngành
                                        </option>
                                        <option value="chuyen_nganh_bat_buoc"
                                            {{ old('loai_mon_hoc') == 'chuyen_nganh_bat_buoc' ? 'selected' : '' }}>Chuyên
                                            ngành bắt buộc</option>
                                        <option value="chuyen_nganh_tu_chon"
                                            {{ old('loai_mon_hoc') == 'chuyen_nganh_tu_chon' ? 'selected' : '' }}>Chuyên
                                            ngành tự chọn</option>
                                        <option value="thuc_tap" {{ old('loai_mon_hoc') == 'thuc_tap' ? 'selected' : '' }}>
                                            Thực tập</option>
                                        <option value="do_an_tot_nghiep"
                                            {{ old('loai_mon_hoc') == 'do_an_tot_nghiep' ? 'selected' : '' }}>Đồ án tốt
                                            nghiệp</option>
                                    </select>
                                    @error('loai_mon_hoc')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select @error('bat_buoc') is-invalid @enderror" id="bat_buoc"
                                        ...
                                        <option value="1" {{ old('bat_buoc') == '1' ? 'selected' : '' }}>Bắt buộc
                                        </option>
                                        <option value="0" {{ old('bat_buoc') == '0' ? 'selected' : '' }}>Tự chọn
                                        </option>
                                    </select>
                                    @error('bat_buoc')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('thu_tu_hoc') is-invalid @enderror"
                                        id="thu_tu_hoc" name="thu_tu_hoc" value="{{ old('thu_tu_hoc') }}" min="1"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('so_tin_chi_toi_thieu') }}" min="1">
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('dao-tao.chuong-trinh-khung.index', ['chuyen_nganh_id' => $chuyenNganh->id]) }}"

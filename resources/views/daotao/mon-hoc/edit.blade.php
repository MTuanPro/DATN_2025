                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('ma_mon') is-invalid @enderror"
                                        id="ma_mon" name="ma_mon" value="{{ old('ma_mon', $monHoc->ma_mon) }}"
                            ...
                            <div class="col-md-8">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('ten_mon') is-invalid @enderror"
                                        id="ten_mon" name="ten_mon" value="{{ old('ten_mon', $monHoc->ten_mon) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('so_tin_chi') is-invalid @enderror"
                                        ...
                                        value="{{ old('so_tin_chi', $monHoc->so_tin_chi) }}" min="1" max="5"
                                        required>
                                    @error('so_tin_chi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('so_tin_chi_ly_thuyet', $monHoc->so_tin_chi_ly_thuyet) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('so_tin_chi_thuc_hanh', $monHoc->so_tin_chi_thuc_hanh) }}"
                                        min="0" max="5" required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select @error('loai_mon') is-invalid @enderror" id="loai_mon"
                                        ...
                                        <option value="dai_cuong"
                                            {{ old('loai_mon', $monHoc->loai_mon) == 'dai_cuong' ? 'selected' : '' }}>Đại
                                            cương</option>
                                        <option value="co_so_nganh"
                                            {{ old('loai_mon', $monHoc->loai_mon) == 'co_so_nganh' ? 'selected' : '' }}>Cơ
                                            sở ngành</option>
                                        <option value="chuyen_nganh_bat_buoc"
                                            {{ old('loai_mon', $monHoc->loai_mon) == 'chuyen_nganh_bat_buoc' ? 'selected' : '' }}>
                                            Chuyên ngành bắt buộc</option>
                                        <option value="chuyen_nganh_tu_chon"
                                            {{ old('loai_mon', $monHoc->loai_mon) == 'chuyen_nganh_tu_chon' ? 'selected' : '' }}>
                                            Chuyên ngành tự chọn</option>
                                        <option value="thuc_tap"
                                            {{ old('loai_mon', $monHoc->loai_mon) == 'thuc_tap' ? 'selected' : '' }}>Thực
                                            tập</option>
                                        <option value="do_an_tot_nghiep"
                                            {{ old('loai_mon', $monHoc->loai_mon) == 'do_an_tot_nghiep' ? 'selected' : '' }}>
                                    ...
                                    <select class="form-select @error('khoa_id') is-invalid @enderror" id="khoa_id"
                                        ...
                                        @foreach ($khoas as $khoa)
                                            <option value="{{ $khoa->id }}"
                                                {{ old('khoa_id', $monHoc->khoa_id) == $khoa->id ? 'selected' : '' }}>
                                                {{ $khoa->ten_khoa }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select @error('hinh_thuc_day') is-invalid @enderror"
                                        ...
                                        <option value="offline"
                                            {{ old('hinh_thuc_day', $monHoc->hinh_thuc_day) == 'offline' ? 'selected' : '' }}>
                                            Offline (Trực tiếp)</option>
                                        <option value="online"
                                            {{ old('hinh_thuc_day', $monHoc->hinh_thuc_day) == 'online' ? 'selected' : '' }}>
                                            Online (Trực tuyến)</option>
                                        <option value="hybrid"
                                            {{ old('hinh_thuc_day', $monHoc->hinh_thuc_day) == 'hybrid' ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('thoi_luong_hoc', $monHoc->thoi_luong_hoc) }}" min="1">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('so_buoi_hoc') is-invalid @enderror"
                                        ...
                                        value="{{ old('so_buoi_hoc', $monHoc->so_buoi_hoc) }}" min="1">
                                    @error('so_buoi_hoc')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('mo_ta') is-invalid @enderror" id="mo_ta" name="mo_ta" rows="4"
                                        placeholder="Nhập mô tả chi tiết về môn học...">{{ old('mo_ta', $monHoc->mo_ta) }}</textarea>
                                    @error('mo_ta')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>

        ...
        <section class="section">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <div class="mt-3 mt-md-0">
                                    <a href="{{ route('dao-tao.ca-hoc.create') }}" class="btn btn-primary">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <h3 class="mb-0">{{ $caHocList->count() }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <h3 class="mb-0">{{ $caHocList->where('trang_thai', true)->count() }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <h3 class="mb-0">{{ $caHocList->where('trang_thai', false)->count() }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-0">
                    ...
                    @forelse ($caHocList as $index => $caHoc)
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <div class="bg-primary bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center" 
                                            ...
                                            <span class="fs-5 fw-bold text-primary">{{ $caHoc->thu_tu }}</span>
                                        </div>
                                    </div>

                                    <!-- Thông tin ca học -->
                                    <div class="col-lg-3 col-md-4">
                                        <h6 class="mb-1 fw-bold">{{ $caHoc->ten_ca }}</h6>
                                        <p class="mb-0 small text-muted">
                                            <i class="bi bi-list-ol"></i> Thứ tự: {{ $caHoc->thu_tu }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-4 mt-3 mt-md-0">
                                        <div class="d-flex align-items-center">
                                            <div class="text-center me-2">
                                                <div class="badge bg-light text-dark border px-3 py-2">
                                                    ...
                                                    <div class="mt-1 fw-bold">{{ date('H:i', strtotime($caHoc->gio_bat_dau)) }}</div>
                                                </div>
                                            </div>
                                            <div class="mx-2">
                                            ...
                                            <div class="text-center ms-2">
                                                <div class="badge bg-light text-dark border px-3 py-2">
                                                    ...
                                                    <div class="mt-1 fw-bold">{{ date('H:i', strtotime($caHoc->gio_ket_thuc)) }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        @php
                                        ...
                                        <div class="mt-2">
                                            <span class="badge bg-info bg-opacity-10 text-info">
                                                <i class="bi bi-hourglass-split"></i> {{ $diff }} phút
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-4 mt-3 mt-lg-0">
                                        ...
                                        @if($caHoc->ghi_chu)
                                            <p class="mb-0 small text-muted">
                                                <i class="bi bi-sticky"></i> {{ Str::limit($caHoc->ghi_chu, 40) }}
                                            </p>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-12 mt-3 mt-lg-0 text-lg-end">
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('dao-tao.ca-hoc.edit', $caHoc->id) }}" 
                                            ...
                                            <button type="button" 
                                                    ...
                                                    onclick="confirmDelete({{ $caHoc->id }})"
                                                    title="Xóa">
                                                <i class="bi bi-trash"></i> Xóa
                                            </button>
                                        </div>
                                        
                                        <form id="delete-form-{{ $caHoc->id }}" 
                                              action="{{ route('dao-tao.ca-hoc.destroy', $caHoc->id) }}" 
                                              method="POST" 
                                              style="display: none;">
                                            @csrf
                                            @method('DELETE')

        ...
        <form action="{{ route('dao-tao.chuyen-nganh.update', $chuyenNganh->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="tong_tin_chi_toi_thieu" id="tong_tin_chi_toi_thieu"
                    ...
                    value="{{ old('tong_tin_chi_toi_thieu', $chuyenNganh->tong_tin_chi_toi_thieu) }}" min="0"
                    max="200">
            ...
            <div class="mb-3">
                ...
                <textarea name="mo_ta" id="mo_ta" class="form-control" rows="4">{{ old('mo_ta', $chuyenNganh->mo_ta) }}</textarea>
            </div>

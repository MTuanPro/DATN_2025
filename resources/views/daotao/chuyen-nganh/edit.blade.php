...
@section('title', 'Chỉnh sửa Chuyên ngành')
                ...
                <div class="card-body">
                    <form action="{{ route('dao-tao.chuyen-nganh.update', $chuyenNganh->id) }}" method="POST">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="ma_chuyen_nganh" name="ma_chuyen_nganh"
                                    ...
                                    value="{{ old('ma_chuyen_nganh', $chuyenNganh->ma_chuyen_nganh) }}" required>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="number" id="tong_tin_chi_toi_thieu" name="tong_tin_chi_toi_thieu"
                                    ...
                                    value="{{ old('tong_tin_chi_toi_thieu', $chuyenNganh->tong_tin_chi_toi_thieu) }}"
                                    min="0" max="200">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <textarea id="mo_ta" name="mo_ta" rows="4" class="form-control @error('mo_ta') is-invalid @enderror">{{ old('mo_ta', $chuyenNganh->mo_ta) }}</textarea>
                                @error('mo_ta')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>

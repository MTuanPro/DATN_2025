        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Sửa Đào tạo</h3>
                    <p class="text-subtitle text-muted">Cập nhật thông tin nhân viên phòng đào tạo</p>
                </div>
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.dao-tao.update', $daoTao) }}" method="POST"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('ho_ten') is-invalid @enderror"
                                        id="ho_ten" name="ho_ten" value="{{ old('ho_ten', $daoTao->ho_ten) }}" required>
                                    @error('ho_ten')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        id="email" name="email" value="{{ old('email', $daoTao->email) }}" required>
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <select class="form-select @error('user_id') is-invalid @enderror" id="user_id"
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}"
                                                {{ old('user_id', $daoTao->user_id) == $user->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            @if ($daoTao->anh_dai_dien)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $daoTao->anh_dai_dien) }}" alt="Current avatar"

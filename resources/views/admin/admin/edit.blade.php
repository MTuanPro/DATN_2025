        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Sửa Admin</h3>
                    <p class="text-subtitle text-muted">Cập nhật thông tin quản trị viên</p>
                </div>
                    ...
                    <form action="{{ route('admin.admin.update', $admin) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('ho_ten') is-invalid @enderror"
                                        id="ho_ten" name="ho_ten" value="{{ old('ho_ten', $admin->ho_ten) }}" required>
                                    @error('ho_ten')
                                    ...
                                    <select class="form-select @error('user_id') is-invalid @enderror" id="user_id"
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}"
                                                {{ old('user_id', $admin->user_id) == $user->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            @if ($admin->anh_dai_dien)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $admin->anh_dai_dien) }}" alt="Current avatar"

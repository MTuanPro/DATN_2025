                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('loai_thong_bao') is-invalid @enderror"
                                        ...
                                        <option value="tin_tuc" {{ old('loai_thong_bao') == 'tin_tuc' ? 'selected' : '' }}>
                                            Tin tức</option>
                                        <option value="thong_bao_chung"
                                            {{ old('loai_thong_bao') == 'thong_bao_chung' ? 'selected' : '' }}>Thông báo
                                            chung</option>
                                        <option value="tin_gap" {{ old('loai_thong_bao') == 'tin_gap' ? 'selected' : '' }}>
                                            Tin gấp</option>
                                        <option value="lich_hoc"
                                            {{ old('loai_thong_bao') == 'lich_hoc' ? 'selected' : '' }}>Lịch học</option>
                                        <option value="lich_thi"
                                            {{ old('loai_thong_bao') == 'lich_thi' ? 'selected' : '' }}>Lịch thi</option>
                                        <option value="hoc_phi" {{ old('loai_thong_bao') == 'hoc_phi' ? 'selected' : '' }}>
                                            Học phí</option>
                                        <option value="diem" {{ old('loai_thong_bao') == 'diem' ? 'selected' : '' }}>Điểm
                                        </option>
                                        <option value="dang_ky_mon"
                                            {{ old('loai_thong_bao') == 'dang_ky_mon' ? 'selected' : '' }}>Đăng ký môn
                                        </option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('muc_do_quan_trong') is-invalid @enderror"
                                        ...
                                        <option value="rat_quan_trong"
                                            {{ old('muc_do_quan_trong') == 'rat_quan_trong' ? 'selected' : '' }}>Rất quan
                                            trọng</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('doi_tuong') is-invalid @enderror" id="doi_tuong"
                                        ...
                                        <option value="all" {{ old('doi_tuong') == 'all' ? 'selected' : '' }}>Tất cả
                                        </option>
                                        <option value="sinh_vien" {{ old('doi_tuong') == 'sinh_vien' ? 'selected' : '' }}>
                                            Sinh viên</option>
                                        <option value="giang_vien"
                                            {{ old('doi_tuong') == 'giang_vien' ? 'selected' : '' }}>Giảng viên</option>
                                        <option value="dao_tao" {{ old('doi_tuong') == 'dao_tao' ? 'selected' : '' }}>Đào
                                            tạo</option>
                                        <option value="admin" {{ old('doi_tuong') == 'admin' ? 'selected' : '' }}>Admin
                                        </option>
                                    </select>
                                    @error('doi_tuong')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local"
                                        ...
                                        name="ngay_het_han" value="{{ old('ngay_het_han') }}">
                                    @error('ngay_het_han')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror

...
@section('content')
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                @if (!isset($lopHocPhan->da_ket_thuc) || !$lopHocPhan->da_ket_thuc)
                    <a href="{{ route('giangvien.nhap-diem.show', $lopHocPhan->id) }}" class="btn btn-success">
                                ...
                                <div class="col-md-6">
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <strong>{{ $lopHocPhan->monHoc->ma_mon ?? '' }}</strong> -
                                                {{ $lopHocPhan->monHoc->ten_mon ?? 'N/A' }}<br>
                                                <span class="badge bg-info">{{ $lopHocPhan->monHoc->so_tin_chi ?? 0 }} tín
                                                    chỉ</span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($phanCong->vai_tro == 'giang_vien_chinh')
                                                    <span class="badge bg-primary"><i class="bi bi-star-fill"></i> Giảng
                                                        viên chính</span>
                                                @elseif($phanCong->vai_tro == 'giang_vien_phu')
                                                    <span class="badge bg-info"><i class="bi bi-person"></i> Giảng viên
                                                        phụ</span>
                                                @elseif($phanCong->vai_tro == 'tro_giang')
                                                    <span class="badge bg-secondary"><i class="bi bi-person-check"></i> Trợ
                                                        giảng</span>
                                                @endif
                                            </td>
                                        </tr>
                                ...
                                <div class="col-md-6">
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <strong class="text-primary">{{ $lopHocPhan->so_luong_dang_ky }}</strong>
                                                / {{ $lopHocPhan->suc_chua }}
                                                @php
                                                    $tyLeDangKy =
                                                        $lopHocPhan->suc_chua > 0
                                                            ? round(
                                                                ($lopHocPhan->so_luong_dang_ky /
                                                                    $lopHocPhan->suc_chua) *
                                                                    100,
                                                                1,
                                                            )
                                                ...
                                                @endphp
                                                <span
                                                    class="badge {{ $tyLeDangKy >= 100 ? 'bg-danger' : ($tyLeDangKy >= 80 ? 'bg-warning' : 'bg-success') }} ms-2">
                                                    {{ $tyLeDangKy }}%
                                                </span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($lopHocPhan->hinh_thuc == 'truc_tiep')
                                                    <span class="badge bg-success"><i class="bi bi-building"></i> Trực
                                                        tiếp</span>
                                                @elseif($lopHocPhan->hinh_thuc == 'online')
                                                    <span class="badge bg-info"><i class="bi bi-camera-video"></i>
                                                        Online</span>
                                                @elseif($lopHocPhan->hinh_thuc == 'hybrid')
                                                    <span class="badge bg-warning"><i class="bi bi-laptop"></i>
                                                        Hybrid</span>
                                                @else
                                                    <span class="text-muted">N/A</span>
                                                @endif
                                                @if ($lopHocPhan->link_online)
                                                    <br><small><a href="{{ $lopHocPhan->link_online }}" target="_blank"
                                                            class="text-primary">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        @forelse($lopHocPhan->lopHocPhanGiangVien as $pc)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a
                                                        href="mailto:{{ $pc->giangVien->email }}">{{ $pc->giangVien->email }}</a>
                                                </td>
                                                <td>
                                                    @if ($pc->giangVien->so_dien_thoai)
                                                        <i class="bi bi-telephone"></i>
                                                        {{ $pc->giangVien->so_dien_thoai }}
                                                    @else
                                                ...
                                                <td>
                                                    @if ($pc->vai_tro == 'giang_vien_chinh')
                                                        <span class="badge bg-primary"><i class="bi bi-star-fill"></i> GV
                                                            Chính</span>
                                                    @elseif($pc->vai_tro == 'giang_vien_phu')
                                                        <span class="badge bg-info"><i class="bi bi-person"></i> GV
                                                            Phụ</span>
                                                    @elseif($pc->vai_tro == 'tro_giang')
                                                        <span class="badge bg-secondary"><i
                                                                class="bi bi-person-check"></i> Trợ giảng</span>
                                                    @else
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="text-center text-muted">Chưa có giảng viên được
                                                    phân công</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                        ...
                                        <tbody>
                                            @foreach ($lichHocCoDinh as $lich)
                                                <tr>
                                                    <td>
                                                        <span class="badge bg-primary">
                                                            @php
                                                                ...
                                                                $thu =
                                                                    $thuMap[$lich->thu_trong_tuan] ??
                                                                    'Thứ ' . $lich->thu_trong_tuan;
                                                            @endphp
                                                            {{ $thu }}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td>
                                                        @if ($lich->link_online)
                                                            <a href="{{ $lich->link_online }}" target="_blank"
                                                                class="text-primary">
                                        ...
                                        <tbody>
                                            @foreach ($sinhViens as $index => $lhpsv)
                                                <tr>
                                                    <td>{{ $index + 1 }}</td>
                                                    <td><strong
                                                            class="text-primary">{{ $lhpsv->sinhVien->ma_sinh_vien }}</strong>
                                                    </td>
                                                    ...
                                                    <td>
                                                        @if ($lhpsv->trang_thai == 'da_xep_lop')
                                                            <span class="badge bg-info"><i class="bi bi-check-circle"></i>
                                                                Đã xếp lớp</span>
                                                        @elseif($lhpsv->trang_thai == 'dang_hoc')
                                                            <span class="badge bg-success"><i
                                                                    class="bi bi-person-check"></i> Đang học</span>
                                                        @elseif($lhpsv->trang_thai == 'da_hoan_thanh')
                                                            <span class="badge bg-primary"><i class="bi bi-trophy"></i> Đã
                                                                hoàn thành</span>
                                                        ...
                                                        @elseif($lhpsv->trang_thai == 'huy_dang_ky')
                                                            <span class="badge bg-secondary"><i
                                                                    class="bi bi-x-octagon"></i> Hủy đăng ký</span>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if ($lhpsv->ngay_dang_ky)
                                                            <small>
                                                                ...
                                                                {{ $lhpsv->ngay_dang_ky->format('d/m/Y') }}<br>
                                                                <i class="bi bi-clock"></i>
                                                                {{ $lhpsv->ngay_dang_ky->format('H:i') }}
                                                            </small>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                        ...
                                        <tbody>
                                            @forelse($danhSachSinhVienKetQua as $index => $lhpsv)
                                                @php
                                                    ...
                                                    $tongBuoi = \App\Models\DiemDanh::whereHas(
                                                        'lopHocPhanSinhVien',
                                                        function ($q) use ($lopHocPhan) {
                                                    ...
                                                    $tyLeDiemDanh =
                                                        $tongBuoi > 0 ? round(($buoiCoMat / $tongBuoi) * 100, 1) : 0;
                                                ...
                                                <tr class="{{ !$duDieuKienThi && $tongBuoi > 0 ? 'table-danger' : '' }}">
                                                    ...
                                                    <td class="text-center">
                                                        @if ($lhpsv->diem_tong_ket)
                                                            <strong
                                                                class="text-primary">{{ number_format($lhpsv->diem_tong_ket, 2) }}</strong>
                                                        @else
                                                            <span class="text-muted">-</span>
                                                        @endif
                                                    </td>
    ...
    @push('scripts')
        <script>
            ...
            // Function xuất danh sách thi - Logic mới
            function xuatDanhSachThi(lopHocPhanId) {
                Swal.fire({
                    title: 'Đang xử lý...',
                ...
                // Gọi API để xuất danh sách thi
                fetch(`{{ url('giang-vien/ket-qua-hoc-tap') }}/${lopHocPhanId}/xuat-danh-sach-thi`, {
                        method: 'POST',
                        headers: {
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            Swal.fire({
                                ...
                                confirmButtonText: 'Xem danh sách thi'
                            }).then((result) => {
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Lỗi',
                                text: data.message || 'Có lỗi xảy ra khi xuất danh sách thi'
                            });
                        }
                    })
                    .catch(error => {

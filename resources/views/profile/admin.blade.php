                                            ...
                                            <div class="col-md-3 text-center mb-4">
                                                <div class="mb-3">
                                                    <img id="preview-avatar"
                                                        src="{{ $admin->anh_dai_dien ? asset('storage/' . $admin->anh_dai_dien) : asset('assets/compiled/jpg/4.jpg') }}"
                                            ...
                                            <div class="col-md-9">
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        <label class="form-label">Mã Admin <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" class="form-control"
                                                            value="{{ $admin->ma_admin }}" disabled>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="ho_ten"
                                                            value="{{ old('ho_ten', $admin->ho_ten) }}" required>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="date" class="form-control" name="ngay_sinh"
                                                            value="{{ old('ngay_sinh', $admin->ngay_sinh instanceof \Carbon\Carbon ? $admin->ngay_sinh->format('Y-m-d') : $admin->ngay_sinh) }}">
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <select class="form-select" name="gioi_tinh">
                                                            ...
                                                            <option value="Nam"
                                                                {{ old('gioi_tinh', $admin->gioi_tinh) == 'Nam' ? 'selected' : '' }}>
                                                                Nam</option>
                                                            <option value="Nữ"
                                                                {{ old('gioi_tinh', $admin->gioi_tinh) == 'Nữ' ? 'selected' : '' }}>
                                                                Nữ</option>
                                                            <option value="Khác"
                                                                {{ old('gioi_tinh', $admin->gioi_tinh) == 'Khác' ? 'selected' : '' }}>
                                                                Khác</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <textarea class="form-control" name="dia_chi" rows="2">{{ old('dia_chi', $admin->dia_chi) }}</textarea>
                                                    </div>

                                                    <div class="col-md-12 mb-3">
                                                        <label class="form-label">Ghi Chú</label>
                                                        <textarea class="form-control" name="ghi_chu" rows="2">{{ old('ghi_chu', $admin->ghi_chu) }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                                            ...
                                            <div class="col-md-3 text-center mb-4">
                                                <div class="mb-3">
                                                    <img id="preview-avatar"
                                                        src="{{ $daoTao->anh_dai_dien ? asset('storage/' . $daoTao->anh_dai_dien) : asset('assets/compiled/jpg/3.jpg') }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ $daoTao->ma_dao_tao }}" disabled>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="ho_ten"
                                                            value="{{ old('ho_ten', $daoTao->ho_ten) }}" required>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="email" class="form-control" name="email"
                                                            value="{{ old('email', $daoTao->email) }}" required>
                                                    </div>

                                                    <div class="col-md-6 mb-3">
                                                        <label class="form-label">Số Điện Thoại</label>
                                                        <input type="text" class="form-control" name="so_dien_thoai"
                                                            value="{{ old('so_dien_thoai', $daoTao->so_dien_thoai) }}">
                                                    </div>

                                                    <div class="col-md-6 mb-3">
                                                        <label class="form-label">Ngày Sinh</label>
                                                        <input type="date" class="form-control" name="ngay_sinh"
                                                            value="{{ old('ngay_sinh', $daoTao->ngay_sinh instanceof \Carbon\Carbon ? $daoTao->ngay_sinh->format('Y-m-d') : $daoTao->ngay_sinh) }}">
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <select class="form-select" name="gioi_tinh">
                                                            ...
                                                            <option value="Nam"
                                                                {{ old('gioi_tinh', $daoTao->gioi_tinh) == 'Nam' ? 'selected' : '' }}>
                                                                Nam</option>
                                                            <option value="Nữ"
                                                                {{ old('gioi_tinh', $daoTao->gioi_tinh) == 'Nữ' ? 'selected' : '' }}>
                                                                Nữ</option>
                                                            <option value="Khác"
                                                                {{ old('gioi_tinh', $daoTao->gioi_tinh) == 'Khác' ? 'selected' : '' }}>
                                                                Khác</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <textarea class="form-control" name="dia_chi" rows="2">{{ old('dia_chi', $daoTao->dia_chi) }}</textarea>
                                                    </div>

                                                    <div class="col-md-12 mb-3">
                                                        <label class="form-label">Ghi Chú</label>
                                                        <textarea class="form-control" name="ghi_chu" rows="2">{{ old('ghi_chu', $daoTao->ghi_chu) }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('dao-tao.phong-hoc.update', $phongHoc->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('ma_phong', $phongHoc->ma_phong)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('ten_phong', $phongHoc->ten_phong)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('suc_chua', $phongHoc->suc_chua)); ?>" min="1" max="500">
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('vi_tri', $phongHoc->vi_tri)); ?>">
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="Lý thuyết"
                                        <?php echo e(old('loai_phong', $phongHoc->loai_phong) == 'Lý thuyết' ? 'selected' : ''); ?>>Lý
                                        thuyết</option>
                                    <option value="Thực hành"
                                        <?php echo e(old('loai_phong', $phongHoc->loai_phong) == 'Thực hành' ? 'selected' : ''); ?>>
                                        Thực hành</option>
                                    <option value="Phòng máy"
                                        <?php echo e(old('loai_phong', $phongHoc->loai_phong) == 'Phòng máy' ? 'selected' : ''); ?>>
                                        Phòng máy</option>
                                    <option value="Hội trường"
                                        <?php echo e(old('loai_phong', $phongHoc->loai_phong) == 'Hội trường' ? 'selected' : ''); ?>>
                                        Hội trường</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>">
                                    <option value="Hoạt động"
                                        <?php echo e(old('trang_thai', $phongHoc->trang_thai) == 'Hoạt động' ? 'selected' : ''); ?>>
                                        Hoạt động</option>
                                    <option value="Bảo trì"
                                        <?php echo e(old('trang_thai', $phongHoc->trang_thai) == 'Bảo trì' ? 'selected' : ''); ?>>Bảo
                                        trì</option>
                                    <option value="Không sử dụng"
                                        <?php echo e(old('trang_thai', $phongHoc->trang_thai) == 'Không sử dụng' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('mo_ta', $phongHoc->mo_ta)); ?></textarea>
...
<?php echo $__env->make('layouts.layout-daotao', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/daotao/phong-hoc/edit.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Chỉnh sửa Ca học'); ?>
    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('dao-tao.ca-hoc.update', $caHoc->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="ten_ca" 
                                           name="ten_ca" 
                                           value="<?php echo e(old('ten_ca', $caHoc->ten_ca)); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                                           id="thu_tu" 
                                           name="thu_tu" 
                                           value="<?php echo e(old('thu_tu', $caHoc->thu_tu)); ?>"
                                           min="1"
                                           max="20"
...
unset($__errorArgs, $__bag); ?>" 
                                           id="gio_bat_dau" 
                                           name="gio_bat_dau" 
                                           value="<?php echo e(old('gio_bat_dau', date('H:i', strtotime($caHoc->gio_bat_dau)))); ?>"
                                           required>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="gio_ket_thuc" 
                                           name="gio_ket_thuc" 
                                           value="<?php echo e(old('gio_ket_thuc', date('H:i', strtotime($caHoc->gio_ket_thuc)))); ?>"
                                           required>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" 
                                               ...
                                               id="trang_thai" 
                                               name="trang_thai"
                                               <?php echo e(old('trang_thai', $caHoc->trang_thai) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              name="ghi_chu" 
                                              rows="3"
                                              placeholder="Nhập ghi chú về ca học (không bắt buộc)"><?php echo e(old('ghi_chu', $caHoc->ghi_chu)); ?></textarea>
                        ...
                        <div class="d-flex justify-content-between">
                            <div>
                                <small class="text-muted">
                                    ...
                                    Cập nhật lần cuối: <?php echo e($caHoc->updated_at->format('d/m/Y H:i')); ?>
...
<?php echo $__env->make('layouts.layout-daotao', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/daotao/ca-hoc/edit.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'Sửa mẫu thông báo tự động'); ?>
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('admin.mau-thong-bao.update', $mauThongBao)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="loai_thong_bao"
                                        ...
                                        <?php $__currentLoopData = $loaiThongBaoOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>"
                                                <?php echo e(old('loai_thong_bao', $mauThongBao->loai_thong_bao) == $key ? 'selected' : ''); ?>>
                                                <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('doi_tuong_mac_dinh', $mauThongBao->doi_tuong_mac_dinh)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                value="<?php echo e(old('tieu_de_mau', $mauThongBao->tieu_de_mau)); ?>"
...
unset($__errorArgs, $__bag); ?>" id="noi_dung_mau"
                                name="noi_dung_mau" rows="8" required><?php echo e(old('noi_dung_mau', $mauThongBao->noi_dung_mau)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="muc_do_uu_tien"
                                        ...
                                        <option value="binh_thuong"
                                            <?php echo e(old('muc_do_uu_tien', $mauThongBao->muc_do_uu_tien) == 'binh_thuong' ? 'selected' : ''); ?>>
                                            Bình thường
                                        </option>
                                        <option value="quan_trong"
                                            <?php echo e(old('muc_do_uu_tien', $mauThongBao->muc_do_uu_tien) == 'quan_trong' ? 'selected' : ''); ?>>
                                            Quan trọng
                                        </option>
                                        <option value="rat_quan_trong"
                                            <?php echo e(old('muc_do_uu_tien', $mauThongBao->muc_do_uu_tien) == 'rat_quan_trong' ? 'selected' : ''); ?>>
                                            Rất quan trọng
                                        </option>
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="gui_email_mac_dinh"
                                            ...
                                            <?php echo e(old('gui_email_mac_dinh', $mauThongBao->gui_email_mac_dinh) ? 'checked' : ''); ?>>
                                ...
                                <div class="form-group mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="gui_sms_mac_dinh"
                                            ...
                                            <?php echo e(old('gui_sms_mac_dinh', $mauThongBao->gui_sms_mac_dinh) ? 'checked' : ''); ?>>
                                ...
                                <div class="form-group mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="kich_hoat" name="kich_hoat"
                                            value="1" <?php echo e(old('kich_hoat', $mauThongBao->kich_hoat) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="ghi_chu" name="ghi_chu"
                                rows="3" placeholder="Ghi chú về mẫu thông báo..."><?php echo e(old('ghi_chu', $mauThongBao->ghi_chu)); ?></textarea>
...
<?php echo $__env->make('layouts.layout-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/admin/mau-thong-bao/edit.blade.php ENDPATH**/ ?>
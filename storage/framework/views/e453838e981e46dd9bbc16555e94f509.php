...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body">
            <form action="<?php echo e(route('giangvien.bao-cao.diem-danh')); ?>" method="GET" class="row g-3">
                <div class="col-md-4">
                ...
                <div class="col-md-4 d-flex align-items-end gap-2">
                    ...
                    <a href="<?php echo e(route('giangvien.bao-cao.diem-danh')); ?>" class="btn btn-secondary">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('giangvien.bao-cao.export-excel', ['loai' => 'diem-danh'] + request()->all())); ?>">
                                    <i class="bi bi-file-earmark-excel"></i> Xuất Excel
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('giangvien.bao-cao.export-pdf', ['loai' => 'diem-danh'] + request()->all())); ?>">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        <?php $tongCoMat = 0; $tongVang = 0; $tongDiTre = 0; $tongNghiPhep = 0; $tongTong = 0; ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo e($item['tong']); ?></td>
                            <td class="text-center">
                                <span class="badge bg-success"><?php echo e($item['co_mat']); ?></span>
                            </td>
                            <td class="text-center">
                                <span class="badge bg-danger"><?php echo e($item['vang']); ?></span>
                            </td>
                            <td class="text-center">
                                <span class="badge bg-warning"><?php echo e($item['di_tre']); ?></span>
                            </td>
                            <td class="text-center">
                                <span class="badge bg-info"><?php echo e($item['nghi_phep']); ?></span>
                            </td>
                            <td class="text-center">
                                <strong class="text-<?php echo e($item['ty_le_co_mat'] >= 80 ? 'success' : ($item['ty_le_co_mat'] >= 60 ? 'warning' : 'danger')); ?>">
                                    <?php echo e($item['ty_le_co_mat']); ?>%
                                </strong>
                            </td>
                        </tr>
                        ...
                        <tr class="table-info fw-bold">
                            ...
                            <td class="text-center"><?php echo e($tongTong); ?></td>
                            <td class="text-center"><?php echo e($tongCoMat); ?></td>
                            <td class="text-center"><?php echo e($tongVang); ?></td>
                            <td class="text-center"><?php echo e($tongDiTre); ?></td>
                            <td class="text-center"><?php echo e($tongNghiPhep); ?></td>
                            <td class="text-center">
                                <?php
...
<?php echo $__env->make('layouts.layout-giangvien', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/giangvien/bao-cao/diem-danh.blade.php ENDPATH**/ ?>
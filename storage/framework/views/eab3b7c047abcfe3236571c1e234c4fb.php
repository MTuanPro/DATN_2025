<?php $__env->startSection('title', 'Sinh viên Dashboard'); ?>
...
<?php $__env->startSection('content'); ?>
                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0"><?php echo e($totalCredits ?? 0); ?></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0"><?php echo e($gpa ?? '0.00'); ?></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0"><?php echo e($currentClasses ?? 0); ?></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0"><?php echo e(number_format($debt ?? 0)); ?>đ</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php if(isset($weeklyTimetable) && $weeklyTimetable->count() > 0): ?>
                                                <?php $__currentLoopData = $weeklyTimetable; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lich): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td><?php echo e($tenThu); ?></td>
                                                        <td>
                                                            <?php if($lich->caHoc): ?>
                                                                <span class="badge bg-primary"><?php echo e($lich->caHoc->ten_ca); ?></span>
                                                            <?php elseif($lich->gio_bat_dau && $lich->gio_ket_thuc): ?>
                                                        ...
                                                        <td><?php echo e($monHoc ? $monHoc->ten_mon : 'N/A'); ?></td>
                                                        <td><?php echo e($lich->phongHoc ? $lich->phongHoc->ten_phong : 'TBA'); ?></td>
                                                        <td><?php echo e($lich->giangVien ? $lich->giangVien->ho_ten : 'TBA'); ?></td>
                                                    </tr>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover table-lg">
                                        ...
                                        <tbody>
                                            <?php if(isset($recentGrades) && $recentGrades->count() > 0): ?>
                                                <?php $__currentLoopData = $recentGrades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        <td><?php echo e($monHoc ? $monHoc->ten_mon : 'N/A'); ?></td>
                                                        <td>
                                                            <span class="badge bg-<?php echo e($grade->diem_chu_badge); ?>">
                                                                <?php echo e($grade->diem_chu ?? 'N/A'); ?>

                                                            </span>
                                                            <?php if($grade->diem_he_10): ?>
                                                                <small class="text-muted ms-1">(<?php echo e(number_format($grade->diem_he_10, 1)); ?>)</small>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php if(isset($upcomingExams) && $upcomingExams->count() > 0): ?>
                                                <?php $__currentLoopData = $upcomingExams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        <td><?php echo e($monHoc ? $monHoc->ten_mon : 'N/A'); ?></td>
                                                        <td>
                                                            <strong><?php echo e(\Carbon\Carbon::parse($exam->ngay_thi)->format('d/m/Y')); ?></strong>
                                                            <?php if($exam->gio_bat_dau): ?>
                                                                <br>
                                                                <small class="text-muted"><?php echo e(\Carbon\Carbon::parse($exam->gio_bat_dau)->format('H:i')); ?></small>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card-content pb-4">
                        <div class="recent-message d-flex px-4 py-3">
                            <div class="name ms-4">
                                ...
                                <h6 class="text-muted mb-0"><?php echo e($studentCode ?? 'N/A'); ?></h6>
                            </div>
                        </div>
                        <div class="recent-message d-flex px-4 py-3">
                            <div class="name ms-4">
                                <h5 class="mb-1">Lớp</h5>
                                <h6 class="text-muted mb-0"><?php echo e($className ?? 'N/A'); ?></h6>
                            </div>
                        </div>
                        <div class="recent-message d-flex px-4 py-3">
                            <div class="name ms-4">
                                <h5 class="mb-1">Khóa</h5>
                                <h6 class="text-muted mb-0"><?php echo e($course ?? 'N/A'); ?></h6>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-content pb-4">
                        <?php if(isset($warnings) && count($warnings) > 0): ?>
                            <?php $__currentLoopData = $warnings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warning): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="recent-message d-flex px-4 py-3">
                                    <div class="name ms-4">
                                        <h5 class="mb-1 text-danger"><?php echo e($warning->type); ?></h5>
                                        <h6 class="text-muted mb-0"><?php echo e($warning->message); ?></h6>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
    ...
    <?php if(isset($thongBaoMoiNhat) && $thongBaoMoiNhat->count() > 0): ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-3 pb-4">
                        <div id="thongBaoCarousel">
                            <?php $__currentLoopData = $thongBaoMoiNhat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $nguoiNhan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($nguoiNhan->thongBao): ?>
                                    <?php
                                        $thongBao = $nguoiNhan->thongBao;
                                    ?>
                                    <div class="thong-bao-item <?php echo e($index === 0 ? 'active' : ''); ?>" data-index="<?php echo e($index); ?>" data-thong-bao-id="<?php echo e($thongBao->id); ?>" data-da-doc="<?php echo e($nguoiNhan->da_doc ? 'true' : 'false'); ?>">
                                        ...
                                        <?php if($thongBao->file_dinh_kem): ?>
                                            <div class="mb-3">
                                                <a href="<?php echo e(Storage::url($thongBao->file_dinh_kem)); ?>" target="_blank" class="btn btn-sm btn-outline-primary">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                                            <div>
                                                <a href="<?php echo e(route('sinh-vien.thong-bao.show', $thongBao->id)); ?>" class="btn btn-primary btn-view-detail">Xem Thêm</a>
                                            </div>
                                            <div class="text-muted text-end">
                                                <small>Ngày <?php echo e($thongBao->ngay_gui->format('d')); ?> tháng <?php echo e($thongBao->ngay_gui->format('m')); ?> năm <?php echo e($thongBao->ngay_gui->format('Y')); ?></small>
                                            </div>
                                        </div>
                                    </div>
                                <?php endif; ?>
                    ...
                    <div class="modal-footer border-top pt-3 pb-3">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <span class="text-muted small" id="thongBaoCounter">1 / <?php echo e($thongBaoMoiNhat->count()); ?></span>
...
<?php echo $__env->make('layouts.layout-sinhvien', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/sinhvien/dashboard.blade.php ENDPATH**/ ?>
    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('dao-tao.mon-hoc.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        id="ma_mon" name="ma_mon" value="<?php echo e(old('ma_mon')); ?>" placeholder="VD: IT101"
                                        required>
...
unset($__errorArgs, $__bag); ?>"
                                        id="ten_mon" name="ten_mon" value="<?php echo e(old('ten_mon')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                        id="so_tin_chi" name="so_tin_chi" value="<?php echo e(old('so_tin_chi')); ?>" min="1"
                                        max="5" required>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('so_tin_chi_ly_thuyet', 0)); ?>" min="0" max="5" required>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('so_tin_chi_thuc_hanh', 0)); ?>" min="0" max="5"
                                        required>
...
unset($__errorArgs, $__bag); ?>" id="loai_mon"
                                        ...
                                        <option value="dai_cuong" <?php echo e(old('loai_mon') == 'dai_cuong' ? 'selected' : ''); ?>>
                                            Đại cương</option>
                                        <option value="co_so_nganh"
                                            <?php echo e(old('loai_mon') == 'co_so_nganh' ? 'selected' : ''); ?>>Cơ sở ngành</option>
                                        <option value="chuyen_nganh_bat_buoc"
                                            <?php echo e(old('loai_mon') == 'chuyen_nganh_bat_buoc' ? 'selected' : ''); ?>>Chuyên ngành
                                            bắt buộc</option>
                                        <option value="chuyen_nganh_tu_chon"
                                            <?php echo e(old('loai_mon') == 'chuyen_nganh_tu_chon' ? 'selected' : ''); ?>>Chuyên ngành
                                            tự chọn</option>
                                        <option value="thuc_tap" <?php echo e(old('loai_mon') == 'thuc_tap' ? 'selected' : ''); ?>>
                                            Thực tập</option>
                                        <option value="do_an_tot_nghiep"
                                            <?php echo e(old('loai_mon') == 'do_an_tot_nghiep' ? 'selected' : ''); ?>>Đồ án tốt nghiệp
                                        </option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option value="offline" <?php echo e(old('hinh_thuc_day') == 'offline' ? 'selected' : ''); ?>>
                                            Offline (Trực tiếp)</option>
                                        <option value="online" <?php echo e(old('hinh_thuc_day') == 'online' ? 'selected' : ''); ?>>
                                            Online (Trực tuyến)</option>
                                        <option value="hybrid" <?php echo e(old('hinh_thuc_day') == 'hybrid' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                        id="thoi_luong_hoc" name="thoi_luong_hoc" value="<?php echo e(old('thoi_luong_hoc')); ?>"
                                        min="1">
...
unset($__errorArgs, $__bag); ?>"
                                        id="so_buoi_hoc" name="so_buoi_hoc" value="<?php echo e(old('so_buoi_hoc')); ?>"
                                        min="1">
...
unset($__errorArgs, $__bag); ?>" id="mo_ta" name="mo_ta" rows="4"
                                        placeholder="Nhập mô tả chi tiết về môn học..."><?php echo e(old('mo_ta')); ?></textarea>
...
<?php echo $__env->make('layouts.layout-daotao', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/daotao/mon-hoc/create.blade.php ENDPATH**/ ?>
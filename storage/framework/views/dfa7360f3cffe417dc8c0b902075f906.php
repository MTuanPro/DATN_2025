<?php $__env->startSection('title', 'Danh Sách Sinh Viên Dự Thi'); ?>
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="<?php echo e(route('dao-tao.lich-thi.phan-phong', $lichThi)); ?>" class="btn btn-secondary">
    ...
    <div class="card mb-4 print-show">
        <div class="card-body">
            <div class="text-center mb-3">
                ...
                <h6><?php echo e($lichThi->lopHocPhan->monHoc->ten_mon_hoc); ?></h6>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <p><strong>Lớp học phần:</strong> <?php echo e($lichThi->lopHocPhan->ma_lop); ?></p>
                    <p><strong>Học kỳ:</strong> <?php echo e($lichThi->lopHocPhan->hocKy->ten_hoc_ky); ?></p>
                    <p><strong>Ngày thi:</strong> <?php echo e(\Carbon\Carbon::parse($lichThi->ngay_thi)->format('d/m/Y')); ?></p>
                </div>
                <div class="col-md-6">
                    <p><strong>Thời gian:</strong> 
                        <?php echo e(\Carbon\Carbon::parse($lichThi->gio_bat_dau)->format('H:i')); ?> - 
                        <?php echo e(\Carbon\Carbon::parse($lichThi->gio_ket_thuc)->format('H:i')); ?>

                    </p>
                    <p><strong>Phòng thi:</strong> <?php echo e($lichThi->phongThi->ten_phong ?? 'Chưa xác định'); ?></p>
                    <p><strong>Hình thức:</strong> 
                        <?php echo e($lichThi->hinh_thuc === 'tai_truong' ? 'Thi tại trường' : 'Thi trực tuyến'); ?>
    ...
    <div class="card mb-4 print-hide">
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('dao-tao.lich-thi.danh-sach-sinh-vien', $lichThi)); ?>">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <select name="phong_thi_id" class="form-select" onchange="this.form.submit()">
                            ...
                            <?php $__currentLoopData = $phongHocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phong): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($phong->id); ?>" 
                                    <?php echo e(request('phong_thi_id') == $phong->id ? 'selected' : ''); ?>>
    ...
    <div class="row mb-4 print-show">
        <div class="col-md-3">
            <div class="card bg-primary text-white">
                <div class="card-body text-center">
                    <h3 class="mb-0"><?php echo e($sinhViens->count()); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card bg-success text-white">
                <div class="card-body text-center">
                    <h3 class="mb-0"><?php echo e($sinhViens->where('trang_thai', 'du_thi')->count()); ?></h3>
                    <small>Dự thi</small>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card bg-warning text-dark">
                <div class="card-body text-center">
                    <h3 class="mb-0"><?php echo e($sinhViens->where('trang_thai', 'vang_co_phep')->count()); ?></h3>
        ...
        <div class="col-md-3">
            <div class="card bg-danger text-white">
                <div class="card-body text-center">
                    <h3 class="mb-0"><?php echo e($sinhViens->where('trang_thai', 'vang_khong_phep')->count()); ?></h3>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $sinhViens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center"><strong><?php echo e($item->so_bao_danh); ?></strong></td>
                                    ...
                                    <td><?php echo e($item->phongThi->ten_phong ?? 'Chưa xác định'); ?></td>
...
<?php echo $__env->make('layouts.layout-daotao', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/daotao/lich-thi/danh-sach-sinh-vien.blade.php ENDPATH**/ ?>
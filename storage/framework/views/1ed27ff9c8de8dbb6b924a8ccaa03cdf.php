<?php $__env->startSection('title', 'Thêm Lớp hành chính'); ?>
    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('dao-tao.lop-hanh-chinh.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        id="ma_lop" name="ma_lop" value="<?php echo e(old('ma_lop')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                        id="ten_lop" name="ten_lop" value="<?php echo e(old('ten_lop')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="khoa_hoc_id"
                                        ...
                                        <?php $__currentLoopData = $khoaHocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $khoaHoc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($khoaHoc->id); ?>"
                                                <?php echo e(old('khoa_hoc_id') == $khoaHoc->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php $__currentLoopData = $giangViens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($gv->id); ?>"
                                                <?php echo e(old('giang_vien_chu_nhiem_id') == $gv->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.layout-daotao', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/daotao/lop-hanh-chinh/create.blade.php ENDPATH**/ ?>
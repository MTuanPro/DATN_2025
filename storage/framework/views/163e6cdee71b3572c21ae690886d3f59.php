<?php $__env->startSection('title', 'Sửa Cấu hình Học phí'); ?>
    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('dao-tao.hoc-phi.cau-hinh.update', $cauHinh->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        id="nam_hoc" name="nam_hoc" value="<?php echo e(old('nam_hoc', $cauHinh->nam_hoc)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('don_gia_tren_tin_chi', $cauHinh->don_gia_tren_tin_chi)); ?>" min="0" step="1000"
...
unset($__errorArgs, $__bag); ?>"
                                        id="phi_dich_vu" name="phi_dich_vu" value="<?php echo e(old('phi_dich_vu', $cauHinh->phi_dich_vu)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                        id="ap_dung_tu_ngay" name="ap_dung_tu_ngay" value="<?php echo e(old('ap_dung_tu_ngay', $cauHinh->ap_dung_tu_ngay->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('ap_dung_den_ngay', $cauHinh->ap_dung_den_ngay ? $cauHinh->ap_dung_den_ngay->format('Y-m-d') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="ghi_chu" name="ghi_chu"
                                rows="3" placeholder="Nhập ghi chú..."><?php echo e(old('ghi_chu', $cauHinh->ghi_chu)); ?></textarea>
...
<?php echo $__env->make('layouts.layout-daotao', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/daotao/hoc-phi/cau-hinh/edit.blade.php ENDPATH**/ ?>
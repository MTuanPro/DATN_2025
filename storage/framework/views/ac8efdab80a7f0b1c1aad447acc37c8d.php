<?php $__env->startSection('title', 'Thanh toán học phí qua MoMo'); ?>
                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo e(route('sinh-vien.hoc-phi.momo-initiate', $hocPhi->id)); ?>" method="POST" id="paymentForm">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.layout-sinhvien', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/sinhvien/hoc-phi/momo-payment.blade.php ENDPATH**/ ?>
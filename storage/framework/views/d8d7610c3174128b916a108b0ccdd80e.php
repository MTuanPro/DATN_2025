<?php $__env->startSection('title', 'Thêm Lịch thi'); ?>
...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('dao-tao.lich-thi.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <?php $__currentLoopData = $lopHocPhans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lhp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($lhp->id); ?>" <?php echo e(old('lop_hoc_phan_id') == $lhp->id ? 'selected' : ''); ?>>
                                            <?php echo e($lhp->ma_lop_hp); ?> - <?php echo e($lhp->monHoc->ten_mon); ?> (<?php echo e($lhp->hocKy->ten_hoc_ky); ?>)
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <option value="giua_ky" <?php echo e(old('loai_thi') == 'giua_ky' ? 'selected' : ''); ?>>Giữa kỳ</option>
                                    <option value="cuoi_ky" <?php echo e(old('loai_thi') == 'cuoi_ky' ? 'selected' : ''); ?>>Cuối kỳ</option>
                                    <option value="thi_lai" <?php echo e(old('loai_thi') == 'thi_lai' ? 'selected' : ''); ?>>Thi lại</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('ngay_thi')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <?php $__currentLoopData = $caHocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $caHoc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($caHoc->id); ?>" <?php echo e(old('ca_hoc_id') == $caHoc->id ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $phongHocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phong): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($phong->id); ?>" <?php echo e(old('phong_thi_id') == $phong->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('so_sinh_vien_du_thi')); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $giangViens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($gv->id); ?>" <?php echo e(old('giam_thi_1_id') == $gv->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $giangViens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($gv->id); ?>" <?php echo e(old('giam_thi_2_id') == $gv->id ? 'selected' : ''); ?>>
                                            <?php echo e($gv->ho_ten); ?> - <?php echo e($gv->ma_giang_vien); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <option value="offline" <?php echo e(old('hinh_thuc') == 'offline' ? 'selected' : ''); ?>>Thi tại trường</option>
                                    <option value="online" <?php echo e(old('hinh_thuc') == 'online' ? 'selected' : ''); ?>>Thi trực tuyến</option>
                                    <option value="hybrid" <?php echo e(old('hinh_thuc') == 'hybrid' ? 'selected' : ''); ?>>Kết hợp</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('link_online')); ?>" placeholder="https://...">
...
unset($__errorArgs, $__bag); ?>" 
                                  placeholder="Ghi chú về lịch thi..."><?php echo e(old('ghi_chu')); ?></textarea>
...
<?php echo $__env->make('layouts.layout-daotao', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/daotao/lich-thi/create.blade.php ENDPATH**/ ?>
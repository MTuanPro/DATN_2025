<?php $__env->startSection('title', 'Thêm Trình độ'); ?>
    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('dao-tao.trinh-do.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('ten_trinh_do')); ?>" placeholder="Ví dụ: Cử nhân, Thạc sĩ, Tiến sĩ..."
                                    required>
...
<?php echo $__env->make('layouts.layout-daotao', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/daotao/trinh-do/create.blade.php ENDPATH**/ ?>
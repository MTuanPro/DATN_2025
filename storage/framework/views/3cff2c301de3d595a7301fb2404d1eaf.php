...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            <p class="greeting">Xin chào <strong><?php echo e($user->name); ?></strong>,</p>

            <p class="message">
                Chào mừng bạn đến với hệ thống quản lý sinh viên <strong>S-MIS</strong>!<br>
                Tài khoản của bạn đã được tạo thành công với email: <strong><?php echo e($user->email); ?></strong>
            </p>
        ...
        <div class="email-footer">
            <p>
                ...
                © <?php echo e(date('Y')); ?> S-MIS - Student Management Information System<br>
...
<?php /**PATH C:\Users\Admin\DATN_2025\resources\views/emails/verify-email.blade.php ENDPATH**/ ?>
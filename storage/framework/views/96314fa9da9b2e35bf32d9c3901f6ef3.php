<?php $__env->startSection('title', 'Tạo thông báo mới'); ?>
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Tạo thông báo gửi đến người dùng</p>
                </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('admin.thong-bao.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        id="tieu_de" name="tieu_de" value="<?php echo e(old('tieu_de')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="noi_dung" name="noi_dung" rows="10"
                                        required><?php echo e(old('noi_dung')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    <small class="text-muted">Định dạng: PDF, DOC, DOCX, XLS, XLSX. Tối đa 10MB</small>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option value="tin_tuc" <?php echo e(old('loai_thong_bao') == 'tin_tuc' ? 'selected' : ''); ?>>
                                            Tin tức</option>
                                        <option value="thong_bao_chung"
                                            <?php echo e(old('loai_thong_bao') == 'thong_bao_chung' ? 'selected' : ''); ?>>Thông báo
                                            chung</option>
                                        <option value="tin_gap" <?php echo e(old('loai_thong_bao') == 'tin_gap' ? 'selected' : ''); ?>>
                                            Tin gấp</option>
                                        <option value="lich_hoc"
                                            <?php echo e(old('loai_thong_bao') == 'lich_hoc' ? 'selected' : ''); ?>>Lịch học</option>
                                        <option value="lich_thi"
                                            <?php echo e(old('loai_thong_bao') == 'lich_thi' ? 'selected' : ''); ?>>Lịch thi</option>
                                        <option value="hoc_phi" <?php echo e(old('loai_thong_bao') == 'hoc_phi' ? 'selected' : ''); ?>>
                                            Học phí</option>
                                        <option value="diem" <?php echo e(old('loai_thong_bao') == 'diem' ? 'selected' : ''); ?>>Điểm
                                        </option>
                                        <option value="dang_ky_mon"
                                            <?php echo e(old('loai_thong_bao') == 'dang_ky_mon' ? 'selected' : ''); ?>>Đăng ký môn
                                        </option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option value="binh_thuong"
                                            <?php echo e(old('muc_do_quan_trong') == 'binh_thuong' ? 'selected' : ''); ?>>Bình thường
                                        </option>
                                        <option value="quan_trong"
                                            <?php echo e(old('muc_do_quan_trong') == 'quan_trong' ? 'selected' : ''); ?>>Quan trọng
                                        </option>
                                        <option value="rat_quan_trong"
                                            <?php echo e(old('muc_do_quan_trong') == 'rat_quan_trong' ? 'selected' : ''); ?>>Rất quan
                                            trọng</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" id="doi_tuong"
                                        ...
                                        <option value="all" <?php echo e(old('doi_tuong') == 'all' ? 'selected' : ''); ?>>Tất cả
                                        </option>
                                        <option value="sinh_vien" <?php echo e(old('doi_tuong') == 'sinh_vien' ? 'selected' : ''); ?>>
                                            Sinh viên</option>
                                        <option value="giang_vien"
                                            <?php echo e(old('doi_tuong') == 'giang_vien' ? 'selected' : ''); ?>>Giảng viên</option>
                                        <option value="dao_tao" <?php echo e(old('doi_tuong') == 'dao_tao' ? 'selected' : ''); ?>>Đào
                                            tạo</option>
                                        <option value="admin" <?php echo e(old('doi_tuong') == 'admin' ? 'selected' : ''); ?>>Admin
                                        </option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="ghim_dau_trang"
                                            ...
                                            <?php echo e(old('ghim_dau_trang') ? 'checked' : ''); ?>>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="gui_email" name="gui_email"
                                            value="1" <?php echo e(old('gui_email') ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('hien_thi_tu_ngay')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="ngay_het_han"
                                        name="ngay_het_han" value="<?php echo e(old('ngay_het_han')); ?>">
...
<?php echo $__env->make('layouts.layout-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/admin/thong-bao/create.blade.php ENDPATH**/ ?>
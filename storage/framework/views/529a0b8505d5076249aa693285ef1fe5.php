                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $diemDanhList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $dd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo e(\Carbon\Carbon::parse($dd->ngay_hoc)->setTimezone('Asia/Ho_Chi_Minh')->format('d/m/Y')); ?> - 
                                                        <?php echo e(\Carbon\Carbon::parse($dd->ngay_hoc)->setTimezone('Asia/Ho_Chi_Minh')->translatedFormat('l')); ?>
                                                    ...
                                                    <td>
                                                        <?php if($dd->thoi_gian_diem_danh): ?>
                                                            <?php echo e(\Carbon\Carbon::parse($dd->thoi_gian_diem_danh)->setTimezone('Asia/Ho_Chi_Minh')->format('H:i d/m/Y')); ?>
                                                    ...
                                                    <td>
                                                        <?php
                                                            ...
                                                            $daCoYeuCau = \App\Models\YeuCauDiemDanhBu::where('lop_hoc_phan_sinh_vien_id', $lhp->id)
                                                                ...
                                                                ->exists();
                                                        ?>
                                                        <?php if($coTheGuiYeuCau && !$daCoYeuCau && in_array($dd->trang_thai, ['vang', 'di_tre'])): ?>
                                                            <button type="button" class="btn btn-sm btn-warning" 
                                                                    onclick="guiYeuCauDiemDanhBu(<?php echo e($dd->lich_hoc_chi_tiet_id); ?>, '<?php echo e($dd->ngay_hoc); ?>')">
                                                                <i class="bi bi-send"></i> Gửi yêu cầu
                                                            </button>
                                                        <?php elseif($daCoYeuCau): ?>
                                                            <span class="badge bg-info">Đã gửi yêu cầu</span>
                                                        <?php elseif(in_array($dd->trang_thai, ['vang', 'di_tre']) && !$coTheGuiYeuCau): ?>
...
document.getElementById('formYeuCauDiemDanhBu').addEventListener('submit', function(e) {
    ...
    fetch('<?php echo e(route("sinh-vien.diem-danh.yeu-cau-diem-danh-bu.store")); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.layout-sinhvien', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\Downloads\DATN_2025_new\resources\views/sinhvien/diem-danh/index.blade.php ENDPATH**/ ?>
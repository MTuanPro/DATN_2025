<?php $__env->startSection('title', 'Cấu hình điểm'); ?>
...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('giangvien.cau-hinh-diem.index')); ?>" method="GET">
                    <div class="row">
                        <div class="col-md-4">
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Danh sách lớp học phần (Chỉ GV chính)</h5>
            </div>
            <div class="card-body">
                <?php if($lopHocPhans->isEmpty()): ?>
                    <div class="alert alert-info">
                        <i class="bi bi-info-circle"></i> Không có lớp học phần nào. Chỉ giảng viên chính mới có quyền cấu hình điểm.
                    </div>
                <?php else: ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $lopHocPhans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $lop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('giangvien.cau-hinh-diem.show', $lop->id)); ?>" 
...
<?php echo $__env->make('layouts.layout-giangvien', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/giangvien/cau-hinh-diem/index.blade.php ENDPATH**/ ?>
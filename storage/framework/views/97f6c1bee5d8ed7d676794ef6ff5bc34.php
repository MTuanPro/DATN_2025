                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" 
                                       ...
                                       id="theme-light" 
                                       value="light" 
                                       <?php echo e(session('theme', 'light') == 'light' ? 'checked' : ''); ?>>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" 
                                       ...
                                       id="theme-dark" 
                                       value="dark" 
                                       <?php echo e(session('theme') == 'dark' ? 'checked' : ''); ?>>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" 
                                       ...
                                       <?php echo e(session('notifications_email', true) ? 'checked' : ''); ?>>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" 
                                       ...
                                       <?php echo e(session('notifications_browser', true) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.layout-daotao', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/settings/index.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Thêm Trạng thái Học tập'); ?>
    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('dao-tao.trang-thai-hoc-tap.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('ten_trang_thai')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                    placeholder="Mô tả chi tiết về trạng thái học tập..."><?php echo e(old('mo_ta')); ?></textarea>
...
<?php echo $__env->make('layouts.layout-daotao', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/daotao/trang-thai-hoc-tap/create.blade.php ENDPATH**/ ?>
    ...
    <div class="page-heading">
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Tạo lớp học phần mới cho học kỳ</p>
                </div>
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('dao-tao.lop-hoc-phan.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    id="ma_lop_hp" name="ma_lop_hp" value="<?php echo e(old('ma_lop_hp')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                    id="ten_lop_hp" name="ten_lop_hp" value="<?php echo e(old('ten_lop_hp')); ?>"
...
unset($__errorArgs, $__bag); ?>" id="mon_hoc_id"
                                    ...
                                    <?php $__currentLoopData = $monHocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $monHoc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($monHoc->id); ?>"
                                            <?php echo e(old('mon_hoc_id') == $monHoc->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="hoc_ky_id"
                                    ...
                                    <?php $__currentLoopData = $hocKys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hocKy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($hocKy->id); ?>"
                                            <?php echo e(old('hoc_ky_id') == $hocKy->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                    id="nhom_lop" name="nhom_lop" value="<?php echo e(old('nhom_lop', 1)); ?>" min="1">
...
unset($__errorArgs, $__bag); ?>"
                                    id="suc_chua" name="suc_chua" value="<?php echo e(old('suc_chua', 50)); ?>" min="10"
                                    max="100">
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('so_luong_toi_thieu', 10)); ?>" min="5" max="30">
...
unset($__errorArgs, $__bag); ?>" id="hinh_thuc"
                                    name="hinh_thuc">
                                    <option value="offline" <?php echo e(old('hinh_thuc') == 'offline' ? 'selected' : ''); ?>>Offline
                                    </option>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <option value="mo_dang_ky"
                                        <?php echo e(old('trang_thai_lop', 'mo_dang_ky') == 'mo_dang_ky' ? 'selected' : ''); ?>>Mở đăng ký</option>
                                    <option value="dang_hoc" <?php echo e(old('trang_thai_lop') == 'dang_hoc' ? 'selected' : ''); ?>>
                                        Đang học</option>
                                    <option value="ket_thuc" <?php echo e(old('trang_thai_lop') == 'ket_thuc' ? 'selected' : ''); ?>>
                                        Kết thúc</option>
                                    <option value="huy" <?php echo e(old('trang_thai_lop') == 'huy' ? 'selected' : ''); ?>>Hủy
                                    </option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" id="ghi_chu" name="ghi_chu" rows="3"><?php echo e(old('ghi_chu')); ?></textarea>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-save"></i> Lưu lớp học phần
                                </button>
...
<?php echo $__env->make('layouts.layout-daotao', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/daotao/lop-hoc-phan/create.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Trợ lý ảo AI'); ?>
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="card shadow-sm chatbot-sidebar-card" style="border-radius: 15px;">
                    ...
                    <div class="card-body p-2 chatbot-sidebar-body chatbot-scrollbar"
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="conversation-item p-2 mb-2" data-id="<?php echo e($conv->id); ?>"
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="fw-bold small text-truncate chatbot-conv-title"
                                            ...
                                            <?php echo e($conv->tieu_de_chat ?? 'Cuộc trò chuyện #' . $conv->id); ?>

                                        </div>
                                        <div class="text-muted small">
                                            <i class="bi bi-clock"></i> <?php echo e($conv->ngay_bat_dau->diffForHumans()); ?>

                                            <span class="badge bg-info bg-gradient ms-1"><?php echo e($conv->messages_count); ?></span>
                                        </div>
                                    </div>
                                    <button class="btn btn-sm btn-danger btn-delete-conv" data-id="<?php echo e($conv->id); ?>"
                                        title="Xóa">
                        ...
                        <?php if($conversations->count() > 0): ?>
                            <a href="<?php echo e(route('sinh-vien.chatbot.history')); ?>"
    ...
    <input type="hidden" id="current-conversation-id" value="<?php echo e($activeConversation->id ?? ''); ?>">
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        <?php if($activeConversation): ?>
            ...
            $('#chat-input-container').show();
            // Load messages
            $.get('/sinh-vien/chatbot/conversation/<?php echo e($activeConversation->id); ?>/messages', function(response) {
                if (response.success) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.layout-sinhvien', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\Downloads\DATN_2025_new\resources\views/sinh-vien/chatbot/index.blade.php ENDPATH**/ ?>
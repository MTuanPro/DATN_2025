<?php $__env->startSection('title', 'Lịch theo Giảng viên'); ?>
    ...
    <div class="page-heading">
        ...
        <section class="section">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('dao-tao.thoi-khoa-bieu.lich-theo-giang-vien')); ?>" class="row g-3">
                        <div class="col-md-3">
                            ...
                            <select class="form-select" id="giang_vien_id" name="giang_vien_id">
                                ...
                                <?php $__currentLoopData = $giangViens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($gv->id); ?>" <?php echo e(request('giang_vien_id') == $gv->id ? 'selected' : ''); ?>>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $lichHocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $lich): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <strong><?php echo e($lich->giangVien->ho_ten ?? 'N/A'); ?></strong>
                                            <br><small class="text-muted"><?php echo e($lich->giangVien->ma_giang_vien ?? 'N/A'); ?></small>
                                        </td>
                                        <td>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <div>
                            <small class="text-muted">
                                ...
                                trong tổng số <?php echo e($lichHocs->total()); ?> buổi dạy
                            </small>
                        </div>
                        <div>
...
<?php echo $__env->make('layouts.layout-daotao', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/daotao/thoi-khoa-bieu/lich-theo-giang-vien.blade.php ENDPATH**/ ?>
    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li
                    class="sidebar-item has-sub <?php echo e(Request::is('dao-tao/lop-hanh-chinh*', 'dao-tao/sinh-vien*') ? 'active' : ''); ?>">
                    <a href="#" class="sidebar-link">
                        <i class="bi bi-people"></i>
                        <span>Lớp hành chính & Sinh viên</span>
                    </a>
                    <ul
                        class="submenu <?php echo e(Request::is('dao-tao/lop-hanh-chinh*', 'dao-tao/sinh-vien*') ? 'active' : ''); ?>">
                        <li class="submenu-item <?php echo e(Request::is('dao-tao/lop-hanh-chinh*') ? 'active' : ''); ?>"><a
                                href="<?php echo e(route('dao-tao.lop-hanh-chinh.index')); ?>">Quản lý Lớp hành
                                chính</a></li>
                        <li class="submenu-item <?php echo e(Request::is('dao-tao/sinh-vien*') ? 'active' : ''); ?>"><a
                                href="<?php echo e(route('dao-tao.sinh-vien.index')); ?>">Quản lý Sinh viên</a>
                        </li>
                    </ul>
                </li>

                
                <li class="sidebar-item <?php echo e(Request::is('dao-tao/giang-vien*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('dao-tao.giang-vien.index')); ?>"
                        class="sidebar-link <?php echo e(Request::is('dao-tao/giang-vien*') ? 'active' : ''); ?>">
                ...
                ?>
                <li class="sidebar-item has-sub <?php echo e($isThoiKhoaBieu ? 'active' : ''); ?>">
                    <a href="#" class="sidebar-link">
                        <i class="bi bi-calendar-check"></i>
                        <span>Thời khóa biểu</span>
                    </a>
                    <ul class="submenu <?php echo e($isThoiKhoaBieu ? 'active' : ''); ?>">
                        <li class="submenu-item <?php echo e(Request::is('dao-tao/thoi-khoa-bieu/lich-theo-phong') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('dao-tao.thoi-khoa-bieu.lich-theo-phong')); ?>">Lịch theo Phòng học</a>
                        </li>
                        <li class="submenu-item <?php echo e(Request::is('dao-tao/thoi-khoa-bieu/lich-theo-giang-vien') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('dao-tao.thoi-khoa-bieu.lich-theo-giang-vien')); ?>">Lịch theo Giảng viên</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item <?php echo e(Request::is('dao-tao/cau-hinh-diem*') || Request::is('dao-tao/lop-hoc-phan/*/cau-hinh-diem*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('dao-tao.cau-hinh-diem.list')); ?>" class="sidebar-link">
...
<?php /**PATH C:\Users\Admin\Downloads\DATN_2025_new\resources\views/layouts/blocks/sidebar-daotao.blade.php ENDPATH**/ ?>
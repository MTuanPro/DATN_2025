                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($sinhVien->lopHanhChinh->khoaHoc->ten_khoa_hoc); ?></td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h3 class="mb-0"><?php echo e($thongKe['tong_tin_chi_ctdt']); ?></h3>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h3 class="mb-0"><?php echo e($thongKe['tin_chi_dat']); ?></h3>
                                    <small class="text-success"><?php echo e(number_format($tienDo, 1)); ?>%</small>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h3 class="mb-0"><?php echo e($thongKe['so_mon_da_hoc']); ?>/<?php echo e($thongKe['so_mon_ctdt']); ?></h3>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <small><?php echo e(number_format($tienDo, 1)); ?>% hoàn thành</small>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading<?php echo e($hocKy); ?>">
                                        <button class="accordion-button <?php echo e($loop->first ? '' : 'collapsed'); ?>" 
                                            ...
                                            <strong>Học kỳ <?php echo e($hocKy); ?></strong>
                                            <span class="ms-3 badge bg-primary">
                                                <?php echo e($monHocs->count()); ?> môn - 
                                                <?php echo e($monHocs->sum(function($m) { return $m->monHoc->so_tin_chi; })); ?> tín chỉ
                                            </span>
                                        </button>
                                    </h2>
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $monHocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            ?>
                                                            <tr class="<?php echo e($daDat ? 'table-success' : ''); ?>">
                                                                <td><?php echo e($loop->iteration); ?></td>
                                                                <td><strong><?php echo e($item->monHoc->ma_mon); ?></strong></td>
                                                                <td>
                                                                    <?php echo e($item->monHoc->ten_mon); ?>
                                                                ...
                                                                <td><span class="badge bg-info"><?php echo e($item->monHoc->so_tin_chi); ?></span></td>
                                                                <td><small><?php echo e($loaiLabels[$item->loai_mon_hoc] ?? $item->loai_mon_hoc); ?></small></td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <?php if($ketQua && $ketQua->diem_he_10): ?>
                                                                        <strong class="<?php echo e($daDat ? 'text-success' : 'text-danger'); ?>">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="mb-0">
                        ...
                        <li>Xem <a href="<?php echo e(route('sinh-vien.chuong-trinh-dao-tao.dieu-kien-tot-nghiep')); ?>">Điều kiện tốt nghiệp</a> để biết thêm chi tiết</li>
                    </ul>
                </div>
            </div>
        </section>
...
<?php echo $__env->make('layouts.layout-sinhvien', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/sinhvien/chuong-trinh-dao-tao/index.blade.php ENDPATH**/ ?>
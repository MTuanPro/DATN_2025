<?php $__env->startSection('title', 'Thêm Chuyên ngành'); ?>
    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('dao-tao.chuyen-nganh.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('ma_chuyen_nganh')); ?>" placeholder="VD: CNPM, HTTT..." required>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('ten_chuyen_nganh')); ?>" placeholder="VD: Công nghệ phần mềm..." required>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <?php $__currentLoopData = $nganhs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nganh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($nganh->id); ?>"
                                            <?php echo e(old('nganh_id') == $nganh->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('tong_tin_chi_toi_thieu', 120)); ?>" min="0" max="200">
...
unset($__errorArgs, $__bag); ?>"
                                    placeholder="Nhập mô tả..."><?php echo e(old('mo_ta')); ?></textarea>
...
<?php echo $__env->make('layouts.layout-daotao', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\DATN_2025\resources\views/daotao/chuyen-nganh/create.blade.php ENDPATH**/ ?>
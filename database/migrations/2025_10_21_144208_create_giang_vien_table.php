...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('giang_vien', function (Blueprint $table) {
            ...
            $table->enum('gioi_tinh', ['Nam', 'Nữ', 'Khác'])->nullable()->comment('Giới tính');
            ...
            $table->foreignId('user_id')->nullable()->unique()->constrained('users')->onDelete('cascade')->comment('Mỗi GV có 1 tài khoản duy nhất (tùy chọn)');
            $table->timestamps();
            $table->softDeletes();
        });
    }
